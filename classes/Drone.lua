...
function Drone.new(x, y, angle, velocity, resource)
    ...
    obj.body = body.new(DRONE_BODY_TYPE, DRONE_RADIUS, DRONE_COLOR)
    obj.controller = controller.new(x, y, obj.body, velocity or math.random(DRONE_VELOCITY_MINIMUM, DRONE_VELOCITY_MAXIMUM), angle or math.rad(math.random(1, 360)))
